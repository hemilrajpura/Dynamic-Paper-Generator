      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" aria-current="page" href="alogin.php">Login</a>
          </li>
        </ul>
...
<?php
  $c=mysqli_connect("localhost","root","");
      if($c)
      {
          ...
          $qry="select * from tbladmin where adminEmail='$email' AND adminPassword='$pass'";
          ...
          {   
            ...
            $f=$row['adminFname'];
            $_SESSION['adminFname']=$f;
    
            $e=$row['adminEmail'];
            $_SESSION['adminEmail']=$e;

            echo "<script> alert('successfully Login'); window.location='questionPaper.php';</script>";
            ob_end_flush();
          }
          else
          {
